...
router.get('/', async (req, res) => {
 ...
 //   let num = req.query.number;
    async function heatles_XD_PAIR_CODE() {
        const {
            state,
            saveCreds
...
Thanks for using *heatless-XD* — your session has been successfully created!
...
https://github.com/XdKing2/heatless-XD

——————

> *© Powered by heatless King*
